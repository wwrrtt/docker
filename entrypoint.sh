...
# 设置 nginx 伪装站
rm -rf /usr/share/nginx/* && wget -c -P /usr/share/nginx "https://github.com/wwrrtt/docker/raw/main/mikutap.zip" && unzip -o "/usr/share/nginx/mikutap.zip" -d /usr/share/nginx/html && rm -f /usr/share/nginx/mikutap.zip
