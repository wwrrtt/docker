...
# 设置 nginx 伪装站
rm -rf /usr/share/nginx/html/* && wget -c -P /usr/share/nginx/html/ "https://github.com/wwrrtt/docker/raw/main/mikutap.zip" && unzip -o "/usr/share/nginx/html/mikutap.zip" -d /usr/share/nginx/html
